...
echo "  DONE"
echo "========================================"
echo "Open on your home Wi‑Fi / reverse proxy:"
echo "  http://${NAS_IP}:8787   (gateway → Windows if up, else NAS)"
echo ""
echo "Data:       $DIR/data"
echo "Downloads:  $DOWNLOAD_DIR"
echo ""
...
echo "Outside access: Reverse Proxy → localhost:8787 (gateway)"
