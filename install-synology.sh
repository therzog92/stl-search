...
echo "  http://${NAS_IP}:8787          (NAS app directly)"
echo "  http://${NAS_IP}:8788          (gateway: Windows first, else NAS)"
echo ""
echo "Data:       $DIR/data"
echo "Downloads:  $DOWNLOAD_DIR"
echo ""
...
echo "Outside access: Reverse Proxy → localhost port 8788 (gateway)"
echo "(prefers your Windows PC when online; falls back to NAS)"
echo "Optional .env: STL_WINDOWS_UPSTREAM=http://YOUR-PC-IP:8787"
echo "========================================"
echo ""
